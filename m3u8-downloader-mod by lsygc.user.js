...
(function() {
    ...
    ajax({
      ...
      success: (fileStr) => {
        if (/(png|image|ts|jpg|mp4|jpeg|EXTINF)/.test(fileStr)) {
          ...
          console.log('【m3u8】----------------------------------------')
          console.log(urlObj)
          console.log('https://cdn.jsdelivr.net/gh/lsygc/m3u8-downloader/index.html?source=' + m3u8Target)
        }
      }
    })
  }
  ...
  " id="m3u8-close">
    ...
    m3u8Jump.addEventListener('click', function() {
      windowOpen('//cdn.jsdelivr.net/gh/lsygc/m3u8-downloader/index.html?source=' + m3u8Target)
    })
    ...
    m3u8Append.addEventListener('click', function() {
      ...
      ajax({
        url: 'https://cdn.jsdelivr.net/gh/lsygc/m3u8-downloader/index.html',
        success: (fileStr) => {
          ...
          $ase.src = 'https://cdn.jsdelivr.net/gh/lsygc/m3u8-downloader/aes-decryptor.js'

          // 加载 mp4 转码
          let $mp4 = document.createElement('script')
          $mp4.src = 'https://cdn.jsdelivr.net/gh/lsygc/m3u8-downloader/mux-mp4.js'

          // 加载 vue
          let $vue = document.createElement('script')
          $vue.src = 'https://cdn.jsdelivr.net/gh/lsygc/m3u8-downloader/vue.js'

          // 加载 stream 流式下载器
          let $streamSaver = document.createElement('script')
          $streamSaver.src = 'https://cdn.jsdelivr.net/gh/lsygc/m3u8-downloader/StreamSaver.js'
